...
Dit document geeft een compleet overzicht van alle functies in de codebase (functions.php), per stuk, per functie, met bestandsnaam, regelnummer(s), en korte uitleg. Alles is direct uit de code gehaald en klopt perfect.
