 ...
 * 1. Het schema-ID wordt uit de URL gehaald via $_GET['id'].
 * 2. Er wordt gecontroleerd of het ID geldig is (numeriek).
 * 3. Het bijbehorende schema wordt opgehaald uit de database.
 * 4. Het formulier wordt vooraf ingevuld met de bestaande gegevens.
 * 5. Bij verzending (POST) worden de gewijzigde gegevens gevalideerd en opgeslagen.
 * 6. Bij succes wordt de gebruiker doorgestuurd naar het dashboard.
 *
 * VERSCHIL MET ADD_SCHEDULE.PHP:
 *   - Deze pagina BEWERKT een bestaand schema in plaats van een nieuw te maken.
 *   - Het formulier is VOORAF INGEVULD met de huidige waarden.
 *   - Er wordt editSchedule() aangeroepen in plaats van addSchedule().
 *   - Er is een extra stap nodig: het schema ophalen uit de database via het ID.
 * ==========================================================================
 */
