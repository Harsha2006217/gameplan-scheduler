 ...
 *
 * Dit bestand toont het privacybeleid (privacy policy) van GamePlan Scheduler.
 * Het is een combinatie van PHP (server-side logica) en HTML (pagina-structuur).
 *
 * WAT IS EEN PRIVACYBELEID?
 * Een privacybeleid is een juridisch document dat uitlegt:
 * - Welke persoonlijke gegevens de applicatie verzamelt
 * - Hoe die gegevens worden opgeslagen en beschermd
 * - Wat er NIET met de gegevens wordt gedaan
 * - Welke rechten de gebruiker heeft over zijn/haar eigen data
 *
 * WAT IS AVG/GDPR?
 * AVG = Algemene Verordening Gegevensbescherming (de Nederlandse naam)
 * GDPR = General Data Protection Regulation (de Engelse naam)
 * Dit is een Europese wet (ingevoerd op 25 mei 2018) die de privacy van
 * EU-burgers beschermt. De wet verplicht ELKE website/applicatie die persoonlijke
 * gegevens verwerkt van EU-burgers om:
 * - Transparant te zijn over welke data wordt verzameld
 * - Data veilig op te slaan met passende beveiligingsmaatregelen
 * - Gebruikers het recht te geven hun data in te zien, te wijzigen en te verwijderen
 * - Geen data te verkopen aan derden zonder expliciete toestemming
 * Overtreding van de AVG kan leiden tot boetes tot 20 miljoen euro of 4% van de jaaromzet!
 *
 * DE PAGINA BEVAT DE VOLGENDE SECTIES:
 * 1. Gegevensverzameling - Welke data wordt opgeslagen
 * 2. Gegevensbeveiliging - Hoe de data wordt beschermd (bcrypt, prepared statements, etc.)
 * 3. Wat Wij Niet Doen - Beloftes over wat er NIET met data gebeurt
 * 4. Jouw Rechten - Wat de gebruiker kan doen met zijn/haar eigen data
 * 5. Contact - Hoe de gebruiker vragen kan stellen over privacy
 *
